 ...
 * dispositivo real ni exportó `schemas/1.json`). Por eso las entidades de Fase 1 y Fase 2
 * ([CapturedNotificationEntity], [CategoryRuleEntity], [CreditCardEntity],
 * [CreditCardStatementEntity], [InstallmentEntity]) se agregan directamente a la versión 1 en
